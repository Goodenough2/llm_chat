...
import { createChatCompletion, stopChat } from '@/utils/api'
...
const handleSend = async (messageContent) => {
  ...
  try {
    ...
    // const messages = chatStore.conversations.find(c => c.id === chatId)?.messages.map(
...
const handleStop = () => {
  try {
    messageHandler.stopStreamResponse()
    stopChat()
  } catch (error) {
